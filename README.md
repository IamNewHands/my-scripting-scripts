...
| **GitHub 工具箱** | [GitHub-Toolbox](./GitHub-Toolbox/README.md) | 一个入口三个 GitHub 工具：Gist 管理、Star 仓库浏览、Actions 工作流监控（含桌面小组件一键触发）。Token 全部存 iOS Keychain。 |
...
├── GitHub-Toolbox/            GitHub 工具箱（Gist/Star/Actions）
├── IPA-Tool/                  IPA 工具
